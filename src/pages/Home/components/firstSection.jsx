...
import me from '../../../assets/img/l1l.png'
...
export const FirstSection = () => {
    ...
    return (
        <>
            <div name="Home" className='w-[100%] flex items-center flex-col relative py-16 max-[430px]:justify-center'>
                <img width={110} className='absolute top-[30px] left-[21.5%] z-20 max-[430px]:top-48 max-[430px]:left-80' src={cowboy} alt="" />
                ...
                <TypeAnimation className='text-2xl text-text font-bold '
                    ...
                    repeat={Infinity}
                />
                    {/* <h1 className='text-2xl text-text font-bold'>Front-End Developer</h1> */}
